...
#if defined CFG_XTAL_40M
extern uint32_t system_clk_t;
#define SYSTEM_CLOCK           system_clk_t
#elif defined HIGHFREQ_MCU160_SUPPORT
...
#define ALWAYS_ON_REGFILE               (SYS_REG_BASE + 0xA00)
...
#define OTA_FLASH_START_ADDR        0x10140000
#define KV_FLASH_START_ADDR         0x101E0000
#define MATTER_FLASH_START_ADDR     0x101EE000
#endif
#define BOOTLOADER_MAX_SIZE         0x10000
#define INFO_MAX_SIZE               0x1000
#define APP_MAX_SIZE                0x100000 // for Matter
#define OTA_MAX_SIZE                0xA0000  // Compress
#define KV_MAX_SIZE                 0xE000
#define MATTER_CONFIG_MAX_SIZE      0x2000

#define FLASH_REMAP_SRC_ADDR_REG    *((volatile unsigned int *)(SYS_REG_BASE + 0x960))
#define FLASH_REMAP_DST_ADDR_REG    *((volatile unsigned int *)(SYS_REG_BASE + 0x960))
#define FLASH_REMAP_SIZE_EN_REG     *((volatile unsigned int *)(SYS_REG_BASE + 0x964))

#define FLASH_REMAP_SRC_ADDR_MASK   0x00003FFF
#define FLASH_REMAP_DST_ADDR_MASK   (0x00003FFF << 14)
#define FLASH_REMAP_EN_MASK         (1 << 14)
#define FLASH_REMAP_SIZE_MASK       0x00003FFF
#define FLASH_REMAP_ROUND_MASK      0x000003FF
