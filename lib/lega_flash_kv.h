 ...
 ****************************************************************************************
 */
#ifndef _LEGA_FLASH_KV_H_
#define _LEGA_FLASH_KV_H_
 ...
 */
int32_t lega_flash_kv_init(void);
 ...
 * @retrun none
 */
void lega_flash_kv_deinit(void);
 ...
 */
int32_t lega_flash_kv_set(const char *key, const void *value, int32_t len, int32_t sync);
 ...
 * @return  0 on success, negative error on failure.
 */
int32_t lega_flash_kv_get(const char *key, void *buffer, int32_t *buffer_len);
 ...
 * @return  0 on success, negative error on failure.
 */
int32_t lega_flash_kv_del(const char *key);

#ifdef __cplusplus
}
#endif
#endif  /* _LEGA_FLASH_KV_H_ */
