...
typedef enum {
    ...
    LEGA_IRQ_TRIGGER_HIGH_LEVEL   = 0x3, /* Interrupt triggered at input signal's high level   */
    LEGA_IRQ_TRIGGER_LOW_LEVEL    = 0x4, /* Interrupt triggered at input signal's low level    */
